...
void button_pressed(const struct device *dev, struct gpio_callback *cb,
    ...
    /*Important note!
    Code in ISR runs at a high priority, therefore, it should be written with
    timing in mind. Too lengthy or too complex tasks should not be performed by
    an ISR, they should be deferred to a thread
    */
}
...
int main(void) {
    ...
    /* Only checking one since led.port and button.port point to the same
     * device, &gpio0 */
